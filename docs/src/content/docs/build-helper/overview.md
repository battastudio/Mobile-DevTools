...
![The Build Helper dashboard — KPIs, charts, and the project-health table with per-app icons, environments, last build, and a security grade.](../../../assets/screenshots/build-helper/dashboard.png)
